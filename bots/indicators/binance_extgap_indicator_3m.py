...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="data/indicators/gaps/binance_extgap_3m_gaps.csv",
        help="Output CSV file for gaps (default: data/indicators/gaps/binance_extgap_3m_gaps.csv)",
    )

    parser.add_argument(
        "--trades-output",
        type=str,
        default="data/indicators/trades/binance_extgap_3m_trades.csv",
        help="Output CSV file for trades (default: data/indicators/trades/binance_extgap_3m_trades.csv)",
    )
