...
- After bearish gap → bearish_candidate = high (opposite extreme)
- After bullish gap → bullish_candidate = low (opposite extreme)
...
async def main():
    ...
    output_path = Path(args.output) if args.output else script_dir / DEFAULT_OUTPUT_DIR / "extgap_detector_v2_gaps.csv"
    log_path = script_dir / DEFAULT_LOG_DIR / "extgap_detector_v2.log"
