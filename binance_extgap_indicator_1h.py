...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="data/binance_extgap_1h_gaps.csv",
        help="Output CSV file for gaps (default: data/binance_extgap_1h_gaps.csv)",
    )

    parser.add_argument(
        "--trades-output",
        type=str,
        default="data/binance_extgap_1h_trades.csv",
        help="Output CSV file for trades (default: data/binance_extgap_1h_trades.csv)",
    )
