...
class TelegramExtGapNotifier:
    ...
    def from_env(cls) -> Optional["TelegramExtGapNotifier"]:
        ...
        - TELEGRAM_BOT_TOKEN_EXTGAP_5M or TELEGRAM_BOT_TOKEN
        - TELEGRAM_CHAT_IDS_EXTGAP_5M or TELEGRAM_CHAT_IDS
        ...
        bot_token = os.getenv("TELEGRAM_BOT_TOKEN_EXTGAP_5M") or os.getenv(
            "TELEGRAM_BOT_TOKEN"
        )
        chat_ids_str = os.getenv("TELEGRAM_CHAT_IDS_EXTGAP_5M") or os.getenv(
            "TELEGRAM_CHAT_IDS"
        )
...
def setup_logging(log_level: str) -> None:
    ...
    logging.basicConfig(
        ...
        handlers=[
            stdout_handler,
            logging.FileHandler("binance_extgap_indicator_5m.log", encoding='utf-8'),
        ],
    )
