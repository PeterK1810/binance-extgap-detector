#!/bin/bash
# Lightweight launcher for all 4 timeframes with proper CSV output paths
# Uses environment variables instead of config/.env
...
echo "================================================"
echo "External Gap Indicator - 4 Timeframe Launcher"
echo "================================================"
echo ""
...
python3 bots/indicators/binance_extgap_indicator_3m.py \
    ...
    >> logs/indicators/extgap_indicator_3m_stdout.log 2>&1 &
PID_3M=$!
PIDS+=($PID_3M)
...
python3 bots/indicators/binance_extgap_indicator_5m.py \
    ...
    >> logs/indicators/extgap_indicator_5m_stdout.log 2>&1 &
PID_5M=$!
PIDS+=($PID_5M)
...
python3 bots/indicators/binance_extgap_indicator_15m.py \
    ...
    >> logs/indicators/extgap_indicator_15m_stdout.log 2>&1 &
PID_15M=$!
PIDS+=($PID_15M)
...
python3 bots/indicators/binance_extgap_indicator_1h.py \
    ...
    >> logs/indicators/extgap_indicator_1h_stdout.log 2>&1 &
PID_1H=$!
PIDS+=($PID_1H)
...
echo ""
echo "================================================"
echo "✅ All 4 bots launched successfully!"
echo "   3m PID: $PID_3M"
echo "   5m PID: $PID_5M"
...
echo ""
echo "CSV Output:"
echo "   Gaps:   data/indicators/gaps/binance_extgap_<tf>_gaps.csv"
echo "   Trades: data/indicators/trades/binance_extgap_<tf>_trades.csv"
echo ""
echo "Logs:"
echo "   logs/indicators/extgap_indicator_<tf>_stdout.log"
echo ""
...
echo "Keeping main process alive for deployment..."
